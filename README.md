...
## Usage
Data for each language's audio is stored in a different folder. The CSV structure is the same across languages.
### Tables
#### Response
...
![alt text](https://github.com/Waxal-Multilingual/speech-data/docs/blob/main/flow.jpg?raw=true)
